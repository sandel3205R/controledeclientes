  ...
  useEffect(() => {
    const fetchClients = async () => {
      const { data: clientsData } = await supabase
        .from('clients')
        .select('id, name, phone, expiration_date, seller_id, plan:plans(name, price)')
